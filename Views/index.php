    ...
    <section id="contPage">
        ...
        <div class="container">
            ...
            <div class="card-ventanilla">
                <h1 class="title-table">Registrar Trámite</h1>
                <div class="row">
                        ...
                        <div class="col-lg-12 filtros">
                            <div class="row">
                                <div class="form-group col-lg-4 col-md-6">
                                    ...
                                    <input class="campo" type="text" id="codigo" name="codigo" placeholder="Escriba...">
                                </div>

                                <div class="form-group col-lg-4 col-md-6">
                                    <label class="form-label" for="tipoTram">Tipo de Trámite:</label>
                                    <select class="campo" class="campo" id="tipoTram" name="tipo">
                                ...
                                <div class="form-group col-lg-4 col-md-6">
                                    ...
                                    <input class="campo" type="number" id="documento" name="documento"  placeholder="Escriba..." required>
                                </div>
                                <div class="form-group col-lg-4 col-md-6">
                                    <label class="form-label" for="apellidos">Apellidos:</label>
                                    <input class="campo" type="text" id="apellidos" name="apellidos"  placeholder="Escriba..." required>
                                </div>
                                <div class="form-group col-lg-4 col-md-6">
                                    <label class="form-label" for="nombres">Nombres:</label>
                                    <input class="campo" type="text" id="nombres" name="nombres"  placeholder="Escriba..." required>
                                </div>
                                <div class="form-group col-lg-4 col-md-6">
                                    <label class="form-label" for="correo">Correo:</label>
                                    <input class="campo" type="email" id="correo" name="correo"  placeholder="Escriba..." required>
                                </div>
                                <div class="form-group col-lg-4 col-md-6">
                                    <label class="form-label" for="telefono">Teléfono:</label>
                                    <input class="campo" type="number" id="telefono" name="telefono"  placeholder="Escriba..." required>
                                </div>
                                <div class="form-group col-lg-4 col-md-6">
                                    <label class="form-label" for="eps">EPS:</label>
                                    <select class="campo" class="campo" id="eps" name="eps" required>
                                        <option value="#">Seleccione</option>
                                ...
                                <div class="form-group col-lg-4 col-md-6">
                                    ...
                                    <input class="campo" type="text" id="direccion" name="direccion"  placeholder="Escriba..." required>
                                </div>
                                <div class="form-group col-lg-12 col-md-12">
                                    <div class="cont-botones-admin">
                                        <button type="submit" class="btn-primary" onclick="activarStepB()"
                                            id="button-section-a">REGISTRAR TRÁMITE</button>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container-fluid" id="cont-table-admin">
            <div class="table-responsive">
                <table class="table table-tramites table-bordered table-hover">
                    <?php
                        seleccionar();
                    ?>
                    ...
                    <tbody>
                        <tr>
                            <th scope="row" class="text-center">1060_2022624T165826230</th>
                            <td>1000835382</td>
                            <td>Niño Benavidez</td>
                            <td>Andres David</td>
                            <td>FOES - Solicitud apoyo educativo.</td>
                            <td>En proceso.</td>
                            <td class="text-center"><a href="#"><i class="bi bi-pencil-square"></i></a></td>
                            <td class="text-center"><a href="#"><i class="bi bi-trash-fill"></i></a></td>
                        </tr>
                        <tr>
                            <th scope="row" class="text-center">1060_2022624T165826230</th>
                            <td>1000835382</td>
